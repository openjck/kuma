(function(win, doc, $) {
    ...
    $.fn.searchSuggestions = function(options) {
        return $(this).each(function() {
            ...
            // Generating and moving all elements necessaires to make this work
            ...
            var $showTopics = $('<button></button>')
              .attr('type', 'button')
              .addClass('show-topics')
              .html('<i class="icon-caret-down" aria-hidden="true"></i>')
              .appendTo($search);
