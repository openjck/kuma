...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('wiki_helpfulvote', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=timezone.now, db_index=True)),
    ...
    models = {
        ...
        'wiki.helpfulvote': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'timezone.now', 'db_index': 'True'}),
